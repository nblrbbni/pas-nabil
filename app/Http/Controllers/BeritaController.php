...
class BeritaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/berita')->with('toast_success', 'News added successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->has('gambar')) {
            ...
            return redirect('/berita')->with('toast_success', 'News updated successfully!');
        }
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/berita')->with('toast_success', 'News successfully deleted!');
    }
}